...
{
    public class BillsPaymentRequestCancelDataAccess : IPostDatabaseData<model>
    {
        private readonly BillsPaymentRequestParamCancelnDataModel _paramData;

        public BillsPaymentRequestCancelDataAccess(BillsPaymentRequestParamCancelnDataModel paramData)
        {
        ...
        public model PostDatabaseData()
        {
            ...
            using (SqlConnection con = new SqlConnection(connString))
            {
                ...
                {
                    cmd.Connection = con;
                    cmd.CommandText = "[adms.bills].[spBillsPaymentRequestCancel]";
